...
import ListBookingUrl from './components/ListBooking/ListBookingUrl';
    ...
    return (
        <Router>
            <Switch>
                ...
                <Route path="/voucher/:tran" component={Voucher}/>
                <Route path="/booking" component={ListBooking}/>
                <Route path="/booking-list/:email" component={ListBookingUrl}/>
            </Switch>
        </Router>
